...
* [Github](https://github.com) and other public repositories. Even Eurocontrol shares some there, such as [himach](https://github.com/david6marsh/himach) and the [PRC dashboard](https://github.com/euctrl-pru/portal).
* Home-made. Making packages is out of the scope of the book, but if you're inside Eurocontrol, you may want to load the `statfor` package created by Sebastien that builds some access to Eurocontrol datawarehouses as well as nice formatting.
